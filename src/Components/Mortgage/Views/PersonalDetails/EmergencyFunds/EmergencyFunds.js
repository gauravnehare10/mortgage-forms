    ...
    <div className="data-display-page">
      ...
      <div className="data-container">
        {formData?.emergenyFundData?.applicant && 
          renderEmergencyFundsSection(formData.emergenyFundData.applicant, 'Applicant Emergency Funds')}
        
        {formData?.emergenyFundData?.partner && 
          renderEmergencyFundsSection(formData.emergenyFundData.partner, 'Partner Emergency Funds')}
      </div>
    </div>
  );
}